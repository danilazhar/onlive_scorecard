...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active"><a href="{{ route('department') }}">Departments</a></li>
...
@section('content')
    ...
    @endif
    <form action="{{ route('department.postUpdate', ['id' => $department->id]) }}" method="POST">
        <div class="row">
            <div class="col-md-9">
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control {{ $errors->has('name') ? 'is-invalid' : null }}"
                                        id="name" placeholder="Department name" value="{{$department->name}}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="description" class="form-control {{ $errors->has('description') ? 'is-invalid' : null }}"
                                        id="description" placeholder="Department description"  value="{{$department->description}}">
