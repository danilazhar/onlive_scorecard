...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active"><a href="{{ route('department') }}">Department</a></li>
...
@section('content')
    ...
    @foreach ($errors->all() as $error)
        {{ $error }}
    @endforeach
    <form action="{{ route('department.postCreate') }}" method="POST">
        <div class="row">
            <div class="col-md-9">
                <div class="card">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control {{ $errors->has('name') ? 'is-invalid' : null }}"
                                        id="code" placeholder="Department name"  value="{{old('old_name')}}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="description" class="form-control {{ $errors->has('description') ? 'is-invalid' : null }}"
                                        id="description" placeholder="Department description"  value="{{old('old_description')}}">
