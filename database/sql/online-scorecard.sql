...
-- Dumping data for table online_scorecard.criterias: ~4 rows (approximately)
...
-- Dumping data for table online_scorecard.departments: ~1 rows (approximately)
...
-- Dumping data for table online_scorecard.department_categories: ~2 rows (approximately)
...
-- Dumping data for table online_scorecard.department_criterias: ~3 rows (approximately)
...
-- Dumping data for table online_scorecard.department_subcategories: ~2 rows (approximately)
INSERT INTO `department_subcategories` (`id`, `department_category_id`, `subcategory_id`, `critical`, `created_by`, `updated_by`, `status`, `created_at`, `updated_at`) VALUES
	(1, 1, 2, 1, 1, 1, 1, '2022-12-30 10:09:00', '2023-01-03 23:14:05'),
	(3, 4, 1, 0, 1, NULL, 1, '2023-01-03 23:09:28', NULL);
...
-- Dumping data for table online_scorecard.passrates: ~1 rows (approximately)
...
-- Dumping data for table online_scorecard.subcategories: ~4 rows (approximately)
...
INSERT INTO `users` (`id`, `role_id`, `department_id`, `name`, `email`, `email_verified_at`, `password`, `is_verified`, `status`, `created_by`, `updated_by`, `remember_token`, `created_at`, `updated_at`) VALUES
	...
	(2, 1, 1, 'Xander Cage', 'xander@yopmail.com', NULL, '$2y$10$tNdjNGBH/S2BJuc8CgjX0.2jvgPmLLoNqF8r4Rt01Z9DKBp9YdYlq', 0, 0, 1, 1, NULL, '2022-12-03 21:39:48', '2022-12-03 22:27:22');
